  ...
  const posts = [
    {
      ...
      comments: [
        ...
        },
        {
          ...
          content: "Great explanation! Could you share more about dependency arrays?",
          time: "1h ago"
        }
      ],
      time: "3 hours ago",
    ...
    },
    {
      ...
      content: "Today I'm sharing my secret technique for perfectly seared scallops! The key is getting the pan screaming hot and making sure your scallops are completely dry before cooking.",
      ...
      comments: [
        {
          ...
          content: "I tried this technique last night and it worked perfectly! Thanks Michael!",
          time: "5h ago"
        }
      ],
      time: "8 hours ago",
    ...
    },
    {
      ...
      content: "I've created a 30-day learning plan to improve my landscape photography skills. I'll be focusing on composition for the first week, then lighting techniques, followed by post-processing.",
      ...
      comments: [
        {
          ...
          content: "This sounds like a great plan! Would you mind sharing some resources you're using?",
          time: "3h ago"
        }
      ],
      time: "1 day ago",
